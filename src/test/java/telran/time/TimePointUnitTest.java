...
public class TimePointUnitTest {
    ...
    void TimePointTest() {
        ...
        assertEquals(1, tpMinute.compareTo(tpSecond));
        assertEquals(-1, tpSecond.compareTo(tpMinute));
        assertEquals(0, tpMinute2.compareTo(tpSecond));
        assertEquals(1, tpHour.compareTo(tpMinute));
    ...
    void FutureProximityAdjusterTest() {
        ...
        TimePoint tpSecond2 = new TimePoint(560, TimeUnit.SECOND); // 560 
        ...
        TimePoint[] timePoints = {tpSecond1, tpSecond2, tpSecond3, tpMinute1, tpMinute2, tpMinute3, tpHour1, tpHour2, tpHour3, tpMinute4, tpMinute5};
        TimePoint[] timePointsSort = {tpMinute1, tpSecond1, tpMinute4, tpMinute5, tpSecond2, tpHour1, tpMinute2, tpHour2, tpSecond3, tpHour3, tpMinute3};
